...
//    }
//
//    private int getBalance(AVLNo no) {
//        return no == null ? 0 : altura(no.esquerda) - altura(no.direita);
//    }
//
//    private AVLNo rodarADireita(AVLNo y) {
//        AVLNo x = y.esquerda;
//        AVLNo T2 = x.direita;
//        x.direita = y;
//        y.esquerda = T2;
...
//    }
//
//    private AVLNo rodarAEsquerda(AVLNo x) {
//        AVLNo y = x.direita;
//        AVLNo T2 = y.esquerda;
//        y.esquerda = x;
//        x.direita = T2;
...
//    public AVLNo insert(AVLNo no, Item item) {
//        if (no == null) {
//            return new AVLNo(item);
//        }
//
//        if (item.getPreco() < no.item.getPreco()) {
//            no.esquerda = insert(no.esquerda, item);
//        } else if (item.getPreco() > no.item.getPreco()) {
//            no.direita = insert(no.direita, item);
//        } else {
//            return no; // Ignora se o preço já existe na árvore
//        }
//
...
//        raiz = insert(raiz, item);
//    }
//
//    // Listar pizzas em ordem crescente de preço
//    public void ordemPizzas() {
//        ordemPizzas(raiz);
//    }
//
//    private void ordemPizzas(AVLNo no) {
//        if (no != null) {
//            ordemPizzas(no.esquerda);
//            if (no.item instanceof Pizza) {
//                System.out.println(no.item);
//            }
//            ordemPizzas(no.direita);
//        }
//    }
//
//    // Listar salgadinhos em ordem crescente de preço
//    public void ordemSalgadinhos() {
//        ordemSalgadinhos(raiz);
//    }
//
//    private void ordemSalgadinhos(AVLNo no) {
//        if (no != null) {
//            ordemSalgadinhos(no.esquerda);
//            if (no.item instanceof Salgadinho) {
//                System.out.println(no.item);
//            }
//            ordemSalgadinhos(no.direita);
//        }
//    }
    private NoAVL raiz;
